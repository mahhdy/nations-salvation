...
\setlist[itemize]{
  ...
  label={\color{PrimaryMid}\textbullet},
  itemsep=1pt,         % between items
  topsep=2pt,          % before first / after last item
  parsep=0pt,
}

\setlist[enumerate]{
  rightmargin=0pt, leftmargin=*,
  label={\color{PrimaryMid}\arabic*.},
  itemsep=1pt,
  topsep=2pt,
  parsep=0pt,
}
...
{\color{AccentGold}\thepart}{0pt}
{\vspace{6pt}\Huge}
[{\color{AccentGold}\titlerule[2pt]}]
